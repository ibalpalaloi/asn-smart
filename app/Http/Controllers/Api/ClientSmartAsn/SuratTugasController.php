...
class SuratTugasController extends Controller
{
	...
	public function index(){
		$surat_tugas = DB::table('surat_tugas')->select('surat_tugas.id', 'surat_tugas.nomor', DB::raw('count(tugas.id) as jumlah_tugas'), DB::raw('count(tugas_asn.id) as jumlah_asn'))->leftJoin('tugas', 'tugas.surat_tugas_id', '=', 'surat_tugas.id')->leftJoin('tugas_asn', 'tugas_asn.id_surat', '=', 'surat_tugas.id')->groupBy('surat_tugas.id', 'surat_tugas.nomor')->get();
